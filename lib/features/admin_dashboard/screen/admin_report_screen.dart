...
class AdminReportScreen extends ConsumerStatefulWidget {
  ...
  @override
  AdminReportScreenState createState() => AdminReportScreenState();
}

class AdminReportScreenState extends ConsumerState<AdminReportScreen> {
  @override
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(
          'Type: ${report.type == Constants.userReportType ? 'User Report' : 'Community Report'}',
          style: const TextStyle(
