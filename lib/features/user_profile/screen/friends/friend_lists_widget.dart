...
class FriendListsWidget extends ConsumerStatefulWidget {
  final String _uid;

  const FriendListsWidget({
    super.key,
    required String uid,
  }) : _uid = uid;

  @override
  ConsumerState<FriendListsWidget> createState() => _FriendListsWidgetState();
}

class _FriendListsWidgetState extends ConsumerState<FriendListsWidget> {
